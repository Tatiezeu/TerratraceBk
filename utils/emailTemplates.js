...
// 2b. Account First-Time Registration & Activation Code Email Template
exports.ActivationCodeEmailTemplate = exports.activationCodeEmail = (code, userName) => `
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
        ...
        <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
                ...
                <tr>
                  <td align="center">
                    ...
                    <div style="width: 64px; height: 64px; margin-bottom: 20px; display: inline-block;">
                      <svg width="64" height="64" viewBox="0 0 48 48" style="display: block;">
                        <defs>
                          <linearGradient id="gold_grad_act_code" x1="8" y1="4" x2="40" y2="44">
                            <stop offset="0%" stop-color="#F4C430"/>
                            <stop offset="50%" stop-color="#D4AF37"/>
                            <stop offset="100%" stop-color="#B8860B"/>
                          </linearGradient>
                        </defs>
                        <path d="M24 4L40 12V36L24 44L8 36V12L24 4Z" fill="url(#gold_grad_act_code)"/>
                        <path d="M24 12V36M16 18H32M18 30L24 36L30 30" stroke="#002147" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
                        <circle cx="24" cy="38" r="4" fill="#002147"/>
                      </svg>
                    </div>
          ...
          <tr>
            <td style="padding: 50px 40px;">
              ...
              <p style="color: #4a5568; font-size: 15px; line-height: 1.7; margin: 0 0 24px 0; text-align: justify; text-justify: inter-word;">
                Hello ${userName},<br/><br/>
                Your registry account has been successfully created. To complete your setup and ensure secure portal access, please verify your email address by entering the activation code below.
              </p>
              ...
              <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  <td align="center" style="padding: 10px 0 30px 0;">
                    <div style="background: linear-gradient(135deg, #f8f9fa 0%, #e9ecef 100%); border: 2px dashed #D4AF37; border-radius: 12px; padding: 25px 35px; display: inline-block;">
                      <p style="color: #6c757d; font-size: 12px; margin: 0 0 10px 0; text-transform: uppercase; letter-spacing: 1.5px; font-weight: 700;">Your Activation Code</p>
                      <div style="font-family: 'Courier New', monospace; font-size: 46px; color: #002147; letter-spacing: 12px; font-weight: 800; margin: 0; padding-left: 12px;">
                        ${code}
                      </div>
                    </div>
              ...
              <p style="color: #718096; font-size: 13px; line-height: 1.6; margin: 0 0 10px 0; text-align: justify; text-justify: inter-word;">
                Note: This activation code is strictly secure and will expire automatically in 24 hours. If you did not register for a TerraTrace account, please ignore this communication.
              </p>
...
// 3. Forgot Password Link Email Template
exports.ForgotPasswordEmailTemplate = exports.forgotPasswordEmail = (resetLink, userName) => `
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Reset Your Password - TerraTrace</title>
</head>
<body style="margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; background-color: #f5f5f5;">
  <table width="100%" cellpadding="0" cellspacing="0" style="background-color: #f5f5f5; padding: 40px 20px;">
    <tr>
        ...
        <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
                ...
                <tr>
                  <td align="center">
                    ...
                    <div style="width: 64px; height: 64px; margin-bottom: 20px; display: inline-block;">
                      <svg width="64" height="64" viewBox="0 0 48 48" style="display: block;">
                        <defs>
                          <linearGradient id="gold_grad_forgot" x1="8" y1="4" x2="40" y2="44">
                            <stop offset="0%" stop-color="#F4C430"/>
                            <stop offset="50%" stop-color="#D4AF37"/>
                            <stop offset="100%" stop-color="#B8860B"/>
                          </linearGradient>
                        </defs>
                        <path d="M24 4L40 12V36L24 44L8 36V12L24 4Z" fill="url(#gold_grad_forgot)"/>
                        <path d="M24 12V36M16 18H32M18 30L24 36L30 30" stroke="#002147" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/>
                        <circle cx="24" cy="38" r="4" fill="#002147"/>
                      </svg>
                    </div>
          ...
          <tr>
            <td style="padding: 50px 40px;">
              ...
              <p style="color: #4a5568; font-size: 15px; line-height: 1.7; margin: 0 0 24px 0; text-align: justify; text-justify: inter-word;">
                Hello ${userName},<br/><br/>
                We received a request to reset the password for your TerraTrace account. To reset your password, please click the secure button below:
              </p>
              ...
              <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  <td align="center" style="padding: 10px 0 30px 0;">
                    <a href="${resetLink}" style="display: inline-block; background: linear-gradient(135deg, #D4AF37 0%, #F4C430 100%); color: #002147; text-decoration: none; padding: 16px 40px; border-radius: 50px; font-size: 15px; font-weight: bold; letter-spacing: 0.5px; box-shadow: 0 6px 20px rgba(212, 175, 55, 0.3); transition: transform 0.2s ease;">
                      Change Password
                    </a>
                  </td>
                </tr>
              ...
              <p style="color: #718096; font-size: 13px; line-height: 1.6; margin: 0 0 10px 0; text-align: justify; text-justify: inter-word;">
                Note: This password reset link is strictly secure and will expire automatically in 1 hour. If you did not request a password reset, please ignore this email.
              </p>
